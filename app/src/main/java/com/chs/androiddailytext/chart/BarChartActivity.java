...
//            }
//        });
//        barChart.setData(data,new int[]{Color.parseColor("#6FC5F4")});
//        barChart.startAnimation();
        ...
        data1.add(new BarChartEntity("暖通组", new Float[]{456f, 741f, 654f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{258f, 951f, 12f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{863f, 45f, 99f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{357f, 235f, 456f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{452f, 321f, 55f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{654f, 555f, 666f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{321f, 333f, 222f}));
        data1.add(new BarChartEntity("暖通组", new Float[]{846f, 111f, 444f}));
