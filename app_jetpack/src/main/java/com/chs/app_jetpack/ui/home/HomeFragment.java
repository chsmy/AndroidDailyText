...
import com.chs.app_jetpack.hilt.HiltSimpleActivity;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_hilt).setOnClickListener(v ->{
            Intent intent = new Intent(requireContext(), HiltSimpleActivity.class);
            startActivity(intent);
        });
    }
